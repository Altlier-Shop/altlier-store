...
export default function StartPage() {
  return (
    <div className="flex w-full h-full">
      <div className="bg-root 2xl:px-20 px-10 py-20" style={{width: '45%'}}>
        <div className="mt-20 h-3/4 overflow-y-scroll">
          ...
          <div className="mt-6 mb-6 grid 2xl:gap-6 lg:gap-4">
            ...
            <p className="leading-10 text-2xl">
              ...
              aliquam et urna vitae vehicula. Praesent volutpat accumsan arcu,
              eu suscipit urna semper at. Nulla pretium velit et elit consequat
              placerat.
            </p>
          </div>
      ...
      <div className="bg-root-secondary" style={{width: '55%'}}>
        <GridPage />
      </div>
    </div>
  );
