import { json, redirect, ActionFunctionArgs } from '@shopify/remix-oxygen';

export async function action({ request, context }: ActionFunctionArgs): Promise<any> {
    ...
    fetch("https://uvg9s9ce04.execute-api.us-east-1.amazonaws.com/Prod/orders", requestOptions)
